...
import { ABOUT_PAGE_IMAGE, PORTFOLIO_IMAGE } from "../Constants/Images/urls";
                ...
                <div className="container-fluid p-3">
                  <div className="row">
                    ...
                    <div className="col-md-8">
                      <div className="m-5">
                        <p className="m-5">
                          Marten Eckerstrom, a distinguished actor trained at
                          the prestigious Lee Strasberg Theatre & Film Institute
                          and the American Academy of Dramatic Arts, stands out
                          with his profound understanding of classical theater
                          and the nuances of method acting. His educational
                          journey in New York has laid a robust groundwork,
                          allowing him to deliver performances that resonate
                          with authenticity and emotional depth. Marten's
                          versatility is evident across a spectrum of roles in
                          acclaimed TV productions and films, as well as in his
                          commanding stage appearances.
                        </p>
                      </div>
                    </div>
                  </div>
